...
#distribution is a perfect fit for the data or not.
...
#Since the skewness is negative which means the data is left skewed, as well as the kurtosis is also very big whereas 
#the skewness for normal distribution is 0 whereas the coefficient of kurtosis is 3 and the JB value is also quite big,
#which shows that the Normal Distribution is not a perfect fit for the data.
...
#So, we can observe that out of 208 trading days from "2021-01-01" to "2021-11-04", there are only 9 trading days(4.32%) 
